...
urlpatterns=[
    ...
    path('dept_auto_monthly_minute/',views.dept_auto_monthly_minute,name='dept_auto_monthly_minute'),
    path('dept_view_autogenerated_minute/<str:j>',views.dept_view_autogenerated_minute,name='dept_view_autogenerated_minute')
